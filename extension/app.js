...
function renderBookmarkTile(bm) {
  ...
  return `<div class="bookmark-tile" draggable="true" data-bm-id="${bm.id}">
    ...
    <div class="bm-tile-click" data-action="open-bookmark" data-bm-url="${safeUrl}" title="${safeTitle}">
      <div class="bm-tile-icon">
        ${faviconUrl ? `<img src="${faviconUrl}" alt="" onerror="this.parentElement.classList.add('no-favicon')">` : ''}
      </div>
      <div class="bm-tile-name">${safeTitle || safeUrl}</div>
